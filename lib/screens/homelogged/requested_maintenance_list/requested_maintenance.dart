...
class RequestedMaintenanceScreen extends StatefulWidget {
  const RequestedMaintenanceScreen({super.key});

  @override
  State<RequestedMaintenanceScreen> createState() =>
      RequestedMaintenanceScreenState();
}

class RequestedMaintenanceScreenState
    extends State<RequestedMaintenanceScreen> {
  @override
  void initState() {
    super.initState();
    // Initial data fetch
    ...
    return Consumer<MaintenanceRequestProvider>(
      builder: (context, maintenanceRequestProvider, child) {
        final maintenanceRequests =
            maintenanceRequestProvider.requestedRequests;
        ...
        if (maintenanceRequests.isEmpty) {
          return Center(child: Text("No Requested requests"));
        }
    ...
    return Scaffold(
      body: Padding(
        ...
        child: RefreshIndicator(
          ...
          child: ListView(
            children: [_buildMaintenanceRequestedRequest(context)],
          ),
        ),
      ),
    );
